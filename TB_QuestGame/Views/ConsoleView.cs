...
namespace TB_QuestGame
{
    ...
    public class ConsoleView
    {
        ...
        /// </summary>
        public ConsoleView(Passenger gamePassenger)
        {
            _gamePassenger = gamePassenger;
        ...
        public PassengerAction GetActionMenuChoice(Menu menu)
        {
            PassengerAction choosenAction = PassengerAction.None;
        ...
        public Character.nationalityType GetRace()
        {
            Character.nationalityType raceType;
            Enum.TryParse<Character.nationalityType>(Console.ReadLine(), out raceType);
        ...
        private void DisplayMenuBox(Menu menu)
        {
            ...
            foreach (KeyValuePair<char, PassengerAction> menuChoice in menu.MenuChoices)
            {
                if (menuChoice.Value != PassengerAction.None)
                {
        ...
        /// </summary>
        /// <returns>Passenger object with all properties updated</returns>
        public Passenger GetInitialPassengerInfo()
        {
            ...
            //
            DisplayGamePlayScreen("Mission Initialization - Name", Text.InitializeMissionGetPassengerName(), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt("Enter your name: ");
            Passenger.Name = GetString();

            //
            // get Passenger's age
            //
            DisplayGamePlayScreen("Mission Initialization - Age", Text.InitializeMissionGetPassengerAge(Passenger), ActionMenu.MissionIntro, "");
            int gamePassengerAge;

            GetInteger($"Enter your age {Passenger.Name}: ", 0, 1000000, out gamePassengerAge);
            Passenger.Age = gamePassengerAge;

            //
            // get Passenger's race
            //
            DisplayGamePlayScreen("Mission Initialization - Race", Text.InitializeMissionGetPassengerRace(Passenger), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt($"Enter your race {Passenger.Name}: ");
            Passenger.Race = GetRace();

            //
            // echo the Passenger's info
            //
            DisplayGamePlayScreen("Mission Initialization - Complete", Text.InitializeMissionEchoPassengerInfo(Passenger), ActionMenu.MissionIntro, "");
            GetContinueKey();
        ...
        {
            DisplayGamePlayScreen("Passenger Information", Text.PassengerInfo(_gamePassenger), ActionMenu.MainMenu, "");
        }
