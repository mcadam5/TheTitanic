...
namespace TB_QuestGame
{
    ...
    public class ConsoleView
    {
        ...
        public void DisplayListOfRoomsLocations()
        {
            DisplayGamePlayScreen("List: Room Locations", Text.ListRoomLocations(_gameTitanic.RoomLocations), ActionMenu.MainMenu, "");
        }

        public void DisplayLookAround()
        {
            DisplayListOfRoomsLocations = currentRoomLocation == _gameTitanic.GetRoomLocationById(_gameTraveler.RoomLocationID);
