...
namespace TB_QuestGame
{
    ...
    public class Controller
    {
        ...
        private void InitializeGame()
        {
            ...
            _gameTitanic = new Titanic();
            _gameConsoleView = new ConsoleView(_gameTraveler, _gameTitanic);
            _playingGame = true;
            ...
            while (_playingGame)
            {
                ...
                switch (travelerActionChoice)
                {
                    ...
                    case TravelerAction.TravelerInfo:
                        ...
                        break;
                    case TravelerAction.ListRoomLocations:
                        _gameConsoleView.DisplayListOfRoomsLocations();
                        break;
