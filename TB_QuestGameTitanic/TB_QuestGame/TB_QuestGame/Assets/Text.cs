...
namespace TB_QuestGame
{
    ...
    public static class Text
    {
        ...
        public static string Travel(Traveler gametraveler, List<RoomLocation> roomLocations)
        {
            string messageBoxText =
                $"{gametraveler.Name}, Titanic will need to know the name of the new location.\n" +
                " \n" +
            ...
            {
                if (roomLocation.SpaceTimeLocationID != gametraveler.RoomLocationID)
                {
                    roomLocationList +=
        ...
        public static string VisitedLocations(IEnumerable<RoomLocation> roomLocations)
        {
            ...
            {
                roomLocationList +=
                    $"{roomLocation.SpaceTimeLocationID}".PadRight(10) +
                    $"{roomLocation.CommonName}".PadRight(30) +
                    Environment.NewLine;
            }
        ...
        public static List<string> StatusBox(Traveler traveler, Titanic titanic)
        {
        ...
        //    foreach (SpaceTimeLocation roomLocation in spaceTimeLocations)
        //    {
        //        if (race != Character.RaceType.None)
        //        {
        //            raceList += $"\t{race}\n";
